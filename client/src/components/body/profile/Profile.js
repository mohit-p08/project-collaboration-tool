/* 
Name of the module: user dashboard

Date of module Creation: 03/10/2021

Author of the module: Mohit Prajapati

What the module does: fetches user details

Functions supported:
1. Login   => Input: accesstoken;              Output: Success/err
*/
...
function Profile() {
    ...
    const updatePassword = () => {
        ...
        try {
            axios.post('/user/resetpassword', { password }, {
                headers: { Authorization: token }
            });
    ...
    //                 setLoading(true);
    //                 await axios.delete(`/user/deleteprofile/${id}`, {
    //                     headers: { Authorization: token }
    //                 });
    //                 setLoading(false);
